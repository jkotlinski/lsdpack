...
The included player is very fast and can easily play back songs that would choke LSDj on a Game Boy Classic. The drawback compared to a normal player is that recordings get very big; an MBC5 cartridge is required.
